...
const LeftSection = () => {
    return (
        <div className='md:w-[600px] md:ml-28 mx-auto'>
            <p className='text-[64px] tracking-tight leading-tight font-semibold text-neutral-900'>Event Registration <br /> Reimagined</p>
